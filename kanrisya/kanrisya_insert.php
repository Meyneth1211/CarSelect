...
<body>
    ...
    <th><h3>メイン画像</h3></th>
        ...
        <label for="main_image" class="file-upload">
            <img src="../img/image.png" alt="アップローボタン" class="upload-button">
        </label>
        <input type="file" name="main_image" required><br></td>
    </tr>
    ...
    <th><h3>その他の画像</h3></th>
        ...
        <label for="main_image" class="file-upload">
            ...
            <input type="file" name="other_images[]" multiple required><br><br></td>
    </tr>
    </table>
