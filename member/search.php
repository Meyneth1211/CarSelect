      ...
      if (chkFavItem($_SESSION['id'],$row['car_id'])) {
        echo '<form action="FavListEditer.php" method="post">';
          ...
          echo '<button type="submit" class="iine">';
            echo '<span style="color:#FF0000; font-size:24px;">&hearts;</span><!-- <img src="icon.png" alt="Submit" style="width: 24px; height: 24px;"> -->';
          echo '</button>';
        echo '</form>';
    } else {
        echo '<form action="FavListEditer.php" method="post">';
        ...
        echo '<input type="hidden" name="url" value="'. $_SERVER['REQUEST_URI'].'">';
          echo '<button type="submit" class="iine">';
            echo '<span style="color:#FF0000; font-size:24px;">&#9825;</span><!--<img src="icon.png" alt="Submit" style="width: 24px; height: 24px;"> -->';
          echo '</button>';
        echo '</form>';
    }
    } else {
