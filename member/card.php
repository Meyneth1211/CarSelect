<?php require('../header/header.php'); ?>
    ...
    <p class="mclass">セキュリティコード<input class="card-cord"type="text" name="cardpass" maxlength="3" size="5"></p>
    <p class="mclass">カード名義<input class="card-name" type="text" name="cardname" maxlength="50"></p>
    <p class="mclass">有効期限<input class="card-kigen" type="text" name="cardkigen" maxlength="2" size="4">/<input class="card-kigen" type="text" maxlength="2" size="4"></p>
    </div>
    <div class="c-button">
